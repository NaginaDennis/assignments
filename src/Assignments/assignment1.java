...
public class assignment1 {
	...
	public static void main(String[] args) {
	    ...
	    //6. Coordinates of a location (latitude, longitude): 37.7749, -122.4194
	     ...
	     System.out.println("6. Latitude of the location: " + latitude + " Longitude of the location: " + longitude + "");
	     
	     //7. Person's marital status: true or false 
	     boolean maritalStstus = true;
		System.out.println("7. Person's marital status:" + maritalStstus);
		...
		short employees = 500;
		System.out.println("15.Number of employees in a company:" + employees);
